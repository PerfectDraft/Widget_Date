...
### 🤖 AI Combo Generator
Tự động lên lịch trình hẹn hò hoàn hảo dựa trên ngân sách, sở thích và thời gian rảnh. Sử dụng mô hình **NVIDIA NIM (Llama 3.3 Nemotron)** qua server proxy, kèm theo cơ chế dự phòng (fallback) thông minh.
...
### 💬 Trợ Lý AI Hẹn Hò
Box chat thông minh sử dụng **NVIDIA NIM (Llama 3.3 Nemotron)** tích hợp sẵn, giúp giải đáp mọi thắc mắc và vạch nhanh ý tưởng hẹn hò ngay lập tức.
...
### AI Services
- **NVIDIA NIM API:** Sử dụng mô hình Llama 3.3 Nemotron Super 49B cho cả tạo combo và chat AI, proxy qua server để bảo vệ API key.

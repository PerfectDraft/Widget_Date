...
export function ComboList({ combos, isLoading, error, onSelectCombo, onSelectVenue, formatVND }: ComboListProps) {
  // 1. Loading State
  if (isLoading) {
    return (
      ...
      <section className="space-y-6 pb-12 mt-8">
        <div className="glass-card rounded-2xl p-8 border border-white/40 shadow-sm text-center">
          ...
          <p className="text-body-md text-on-surface-variant">
            Hãy chọn các tiêu chí ở trên và bấm "Tạo Combo AI" để Widget Date gợi ý cho bạn nhé!
          </p>
        </div>
      </section>
    );

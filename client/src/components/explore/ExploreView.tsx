            ...
            {getSortedPlaces().map(loc => (
              <div key={loc.id} className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex flex-col gap-3">
                ...
                <div className="grid grid-cols-3 gap-2 mt-1">
                  <button onClick={() => showToast('Đã thêm vào combo!')} className="bg-purple-50 hover:bg-purple-100 text-purple-700 py-2 rounded-xl text-xs font-bold transition-colors flex items-center justify-center gap-1"><Plus className="w-3 h-3" /> Combo</button>
